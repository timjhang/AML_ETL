...
public class ETL_Bean_DM_ACCTMAPPING_LOAD_Data {
	...
	public ETL_Bean_DM_ACCTMAPPING_LOAD_Data(ETL_Tool_DM_ParseFileName pfn) {
	...
	public String getNew_account_id() {
		return new_account_id;
	}

	public void setNew_account_id(String new_account_id) {
