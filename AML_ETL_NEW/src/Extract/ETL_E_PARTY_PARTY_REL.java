...
public class ETL_E_PARTY_PARTY_REL extends Extract {

	public ETL_E_PARTY_PARTY_REL() {
		
	}

	public ETL_E_PARTY_PARTY_REL(String filePath, String fileTypeName, String batch_no, String exc_central_no,
	...
	public void read_File() {
		try {
			read_Party_Party_Rel_File(this.filePath, this.fileTypeName, this.batch_no, this.exc_central_no,
...
//								data.setError_mark("Y");
			...
			try {
				...
				ETL_P_EData_Filter.E_Datas_Filter("filter_Party_Party_Rel_Temp_Temp",
	...
	private void insert_Party_Party_Rel_Datas() throws Exception {
		...
		if (isSuccess) {
			System.out.println("insert_Party_Party_Rel_Datas 寫入 " + this.dataList.size() + "(-" + errorCount + ")筆資料!");
	...
	public static void main(String[] argv) throws Exception {
		...
		one.read_Party_Party_Rel_File(filePath, fileTypeName, "E8888888", "600",
				new SimpleDateFormat("yyyyMMdd").parse("20171206"), "001", "ETL_E_PARTY_PARTY_REL");
	}
