...
public class ETL_E_FCX extends Extract {
	...
	public ETL_E_FCX(String filePath, String fileTypeName, String batch_no, String exc_central_no,
	...
	public void read_File() {
		try {
			read_FCX_File(this.filePath, this.fileTypeName, this.batch_no, this.exc_central_no,
