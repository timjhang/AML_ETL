...
public class ETL_T_LOAN_LOAD extends Transform {
	
	public ETL_T_LOAN_LOAD() {
		
	}

	public ETL_T_LOAN_LOAD(ETL_Bean_LogData logData) {
		super(logData);
	}
	...
	public void trans_File() {
		try {
			trans_to_LOAN_LOAD(this.logData);
		} catch (Exception e) {
			e.printStackTrace();
		} 
	}
	
	// 觸發DB2轉換Procedure, 轉換資料寫進LOAN_LOAD
