...
public class ETL_T_PARTY extends Transform {
	
	public ETL_T_PARTY() {
		
	}

	public ETL_T_PARTY(ETL_Bean_LogData logData) {
		super(logData);
	}
	...
	public void trans_File() {
		try {
			trans_to_PARTY_LOAD(this.logData);
		} catch (Exception e) {
			e.printStackTrace();
		} 
	}

	// 觸發DB2轉換function, 轉換資料寫進PARTY_LOAD
	...
	public static void main(String[] argv) {
		...
		ETL_T_PARTY one = new ETL_T_PARTY();
