...
public class ETL_Tool_Folder {
	...
	/**
	 * 刪除各單位 D:\ETL\DB910\DOWNLOAD 底下檔案 某個日期之前 ex:910MASTER_20180625_185224.txt 133
	 * 
	 * @param deleteBefDate
	 * @throws Exception
	 */
	...
	public static boolean clearETLFile(Date deleteBefDate) {
	...
	public static boolean clearGAMLFile(Date deleteBefDate) {
		boolean isSuccess = false;
	...
	public static void main(String[] args) throws Exception {
		...
		//clearGAMLFile(ETL_Tool_StringX.toUtilDate("20180628"));
		
		 dropETL(ETL_Tool_StringX.toUtilDate("20180628"));
